...
def main_func(activation, data_path, save_path, batch_size, epochs, layer_sizes, mi_methods, num_bins=30, num_runs=1, try_gpu=False):
    ...
    for i in tqdm.tqdm(range(num_runs)): 
        ...
        if "variable" in mi_methods:
            ...
            with open(save_path + '/MI_XH_MI_YH_run_{}_{}_{}variable.pickle'.format(i, ext, num_bins), 'wb') as f:
        ...
        if "fixed" in mi_methods:
            ...
            with open(save_path + '/MI_XH_MI_YH_run_{}_{}_{}bins.pickle'.format(i, ext, num_bins), 'wb') as f:
        ...
        if "adaptive" in mi_methods:
            ...
            with open(save_path + '/MI_XH_MI_YH_run_{}_{}_{}adaptive.pickle'.format(i, ext, num_bins), 'wb') as f:
                pickle.dump([MI_XH2, MI_YH2], f, protocol=pickle.HIGHEST_PROTOCOL)
                f.close()
